...
from .views import login, dashboard, logout, titulo, buscarDadosTituloAjax, buscarTituloAjax,\
    ...
    buscarDadosOrigemAjax, getDataHoraAjax, controleCampo, buscarDadosControleCampoAjax
...
urlpatterns = [
    ...
    path('configuracoes/buscarDadosControleCampoAjax', buscarDadosControleCampoAjax, name='buscarDadosControleCampoAjax'),
